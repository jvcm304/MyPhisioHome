...
require 'controladores/pacientes.php';
require 'controladores/ejercicios.php';
require 'controladores/ejerciciosPlanes.php';
require 'controladores/planes.php';
require 'controladores/planesUsuarios.php';
require 'controladores/seguimiento.php';
...
$recursos_existentes = array('ejercicios', 'planes','pacientes','ejerciciosPlanes','planesUsuario','seguimiento');
...
switch ($metodo) {
    case 'get':
        $vista->imprimir($recurso::get($peticion));
        break;
    case 'post':
        $vista->imprimir($recurso::post($peticion));
        break;
    case 'put':
        $vista->imprimir($recurso::put($peticion));
        break;
    case 'delete':
