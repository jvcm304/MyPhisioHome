...
import com.myphisiohome.myphisiohome.Dialogos.DialogAddPaciente;
import com.myphisiohome.myphisiohome.R;


public class AddPacienteActivity extends AppCompatActivity implements
    ...
    private void crearFullScreenDialog() {
        ...
        DialogAddPaciente newFragment = new DialogAddPaciente();
    ...
    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
        ...
        DialogAddPaciente fragment = (DialogAddPaciente) getSupportFragmentManager().findFragmentByTag("FullScreenFragment");
        if (fragment != null) {
