...
public class GetEjerciciosTask extends AsyncTask<Void, Void, Integer> {
    ...
    public GetEjerciciosTask(int idPlan, Context context) {
                        ...
                        if(estado!=1) {
                            ...
                            try{
                                ...
                                for (int j=0; j<ejerciciosJSON.length() ;j++) {
                                    ...
                                    float repe;
                                    Log.e("IDEJERCICIO___>",Integer.toString(idEjercicio));
                                    ejercicio= new Ejercicio(ejercicioObj.getInt("idEjercicio"),ejercicioObj.getString("nombre"),
